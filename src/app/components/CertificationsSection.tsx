          ...
          {t.certifications.items.map((cert, index) => (
            ...
            >
              <div className="flex items-start gap-3 mb-3">
                ...
                >
                  <span className="text-white font-bold text-xs" style={{ fontFamily: "'Inter', sans-serif" }}>
                    {cert.logo}
                  </span>
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <h3 className="text-white text-sm font-semibold leading-tight" style={{ fontFamily: "'Inter', sans-serif" }}>
                    {cert.title}
                  </h3>
                </div>
              </div>
