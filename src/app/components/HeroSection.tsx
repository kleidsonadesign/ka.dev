...
export function HeroSection() {
  ...
  const projects = [
    { name: t.hero.projects[0].name, gradient: "from-white/5 to-white/10", image: wagooImage, url: t.hero.projects[0].url },
    { name: t.hero.projects[1].name, gradient: "from-white/5 to-white/10", image: korvenImage, url: t.hero.projects[1].url },
    { name: t.hero.projects[2].name, gradient: "from-white/5 to-white/10", image: "/images/papupfy.png", url: t.hero.projects[2].url },
    { name: t.hero.projects[3].name, gradient: "from-white/5 to-white/10", image: "/images/2avendas.png", url: t.hero.projects[3].url },
    { name: t.hero.projects[4].name, gradient: "from-white/5 to-white/10", image: inssImage },
  ];
        ...
        >
          ...
          >
            {t.hero.badges.map((badge, index) => (
              <div key={badge} className="flex items-center flex-wrap gap-2">
                <span>{badge}</span>
                {index < t.hero.badges.length - 1 && (
          ...
          <div className="grid lg:flex lg:flex-col gap-4 lg:gap-3">
            ...
            <div className="grid grid-cols-1 gap-2 lg:space-y-1.5 lg:block">
              ...
              >
                ...
                <span className="font-mono">{currentTime.toLocaleTimeString(language === "pt" ? "pt-BR" : "en-US")}</span>
              </div>
              <p 
