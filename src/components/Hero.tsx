      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="mb-8 text-center lg:text-left h-12 overflow-hidden">
              <motion.p
                ...
                exit={{ y: -20, opacity: 0 }}
                className="text-gray-300 tracking-widest uppercase font-medium"
              >
          ...
          <motion.div className="flex items-center justify-center">
            <div className="info-block w-full p-12">
              <h2 className="mb-10 text-center leading-tight">
              ...
              <div className="space-y-6 mt-10">
                {skills.map((skill, index) => (
                  <div key={index} className="flex items-center gap-4 py-4 border-b border-gray-800/50 last:border-b-0 group">
                    <skill.icon size={28} className="text-primary group-hover:text-accent transition-colors" />
                    <span className="text-gray-300 group-hover:text-white transition-colors">{skill.text}</span>
                  </div>
                ))}
              </div>
            </div>
