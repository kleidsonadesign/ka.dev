...
<div className="absolute inset-0 overflow-hidden -z-10">
  ...
  <motion.div 
    ...
    animate={{ 
      ...
      y: [0, -20, 0]    // Movimento vertical
    }}
    transition={{ 
      duration: 12, // Duração de 12 segundos
      repeat: Infinity, 
      repeatType: "reverse",
      ease: "easeInOut"
    }}
  ...
  {/* Bola 2 (Original, agora maior e animada) */}
  <motion.div 
    ...
    transition={{ 
      duration: 15, // Duração diferente para não parecer robótico
      repeat: Infinity, 
      repeatType: "reverse",
      ease: "easeInOut",
      delay: 3 // Começa com atraso
    }}
  />
